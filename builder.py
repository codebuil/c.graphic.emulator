...
class BareboneBuilder:
    ...
    def build_kernel(self):
        ...
        self.execute_command("unzip -u ./file/CD_root.zip -d /tmp",True)
        ...
        self.execute_command("nasm -o /tmp/hello.com ./file/loader.asm",True)
        ...
        self.execute_command("cp -f /tmp/hello.com /tmp/CD_root/isolinux/",True)
        self.execute_command("cp -f ./*.raw /tmp/CD_root/isolinux",False)
